        ...
        <div class="container">
            <div class="row">
                <div class="col-12 fora">
                    <div class="dentro">
                        <h1>Alocação inserida com sucesso!</h1>
                        <br>
                        <a href="cadastroalocacao.php?id='.$id.'"><button type="button"  id="btn">Cadastrar outra alocação</button></a><br><br>
                        <a href="#"><button type="button"  id="btn">Alocações cadastradas</button></a>
                        <style>
                            .fora{
                                display: flex;
                                height: 10vh;
