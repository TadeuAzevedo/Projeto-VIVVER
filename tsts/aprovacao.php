...
if($result && $prioridade == 1){
	echo "<script>setTimeout(function(){ alert('Visita aprovada com prioridade!'); window.location.href = 'visitaspendentes.php?id=$id'}, 1000);</script>";
}else if($result && $novaSituacao == 2){
